...
class QuestionsService
{
    ...
    public function deleteQuestion($questionIndex) {
        if(array_key_exists($questionIndex, self::$questions)) {
            array_splice(self::$questions, $questionIndex, 1);
            return ['success' => true, 'message' => 'Вопрос удален'];
        } else {
            return ['success' => false, 'message' => 'Вопрос с таким индексом не найден'];
        }
    }
}
QuestionsService::initQuestions();